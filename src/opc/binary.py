...
def create_binary_mask_from_vertices_full_region(
...
def create_binary_mask_from_vertices_max_vertices_region(
    vertices, vertices_polygon_ids, width, height, device=None
):
    """Create a binary mask where points inside any of the polygons are marked as 1 and others as
    0.
...
def create_binary_mask_from_vertices_with_padding(
    vertices, vertices_polygon_ids, width, height, device=None
):
    """Create a binary mask where points inside any of the polygons are marked as 1 and others as
    0.
